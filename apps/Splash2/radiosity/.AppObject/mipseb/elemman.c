  ...
  unsigned process_id;
{
    ...
    printf( "Interaction(0x%lx)\n", (long)((uintptr_t)inter) ) ;
    printf( "    Dest: Elem (0x%lx) of patch %d\n",
           (long)((uintptr_t)inter->destination), inter->destination->patch->seq_no ) ;
    printf( "    Fout: %f    Vis: %f\n",
...
/* Generated from ../Changed/elemman.C */
